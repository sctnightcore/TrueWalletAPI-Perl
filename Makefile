# This Makefile is for the TrueWallet::Api extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/TrueWallet/Api.pm]
#     AUTHOR => [q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[TrueWallet::Api]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/TrueWallet/Api.pm]
...
MAKE = gmake
FULLEXT = TrueWallet\Api
BASEEXT = Api
PARENT_NAME = TrueWallet
DLBASE = $(BASEEXT)
VERSION_FROM = lib/TrueWallet/Api.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)\TrueWallet
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\TrueWallet
...
TO_INST_PM = lib/TrueWallet/Api.pm
...
DISTNAME = TrueWallet-Api
DISTVNAME = TrueWallet-Api-0.01
...
Api.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"TrueWallet::Api\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "  - 'A. U. Thor <a.u.thor@a.galaxy.far.far.away>'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: TrueWallet-Api" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "x_serialization_backend: YAML version 1.27" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) { > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Perl extension for blah blah blah\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"A. U. Thor ^<a.u.thor^@a.galaxy.far.far.away^>\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"TrueWallet-Api\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   \"x_serialization_backend\" : \"JSON version 2.97001\"" >> META_new.json
	$(NOECHO) $(ECHO) } >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"TrueWallet-Api\" VERSION=\"0.01\">" > TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl extension for blah blah blah</ABSTRACT>" >> TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>A. U. Thor &lt;a.u.thor@a.galaxy.far.far.away&gt;</AUTHOR>" >> TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.28\" />" >> TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> TrueWallet-Api.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> TrueWallet-Api.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/TrueWallet/Api.pm blib\lib\TrueWallet\Api.pm 
